...
public:
    ...
    // ----- MANIPULATORS
        ...
        /**
     * Log variable bilgilerinin bulunacagi heapi yaratir.
     * @param heapsize Yaratilacak heap boyutu
     * @return Heap basari ile yaratilirsa 0, aksi takdirde heap hata kodu
     *         getirilir.
     */
    int createHeap(int heapsize);

    int deleteHeap();

    /**
     * Log variable bilgilerinin bulunacagi heape baglanir.
     * @return Heap basari ile yaratilirsa 0, aksi takdirde heap hata kodu
     *         getirilir.
     */
