...
struct ZVrmlActions : openvrml::null_vrml97_parse_actions
{
    ...
    struct on_mfcolor_t
    {
        ...
        {            
            parent.attribute.vZColors.clear();
    ...
    struct on_mffloat_t
    {
        ...
        void operator()(const std::vector<float> &floats) const
        {
            ...
            parent.attribute.vDoubles.clear();
    ...
    struct on_mfint32_t
    {
        ...
        {
        	parent.attribute.vIntegers.clear();
    ...
    struct on_mfrotation_t
    {
        ...
        {
            parent.attribute.vZRotations.clear();
    ...
    struct on_mfvec2f_t
    {
        ...
        {
            parent.attribute.vZVector2Ds.clear();
            for(unsigned int i = 0; i < vec2fs.size(); ++i)
    ...
    struct on_mfvec3f_t
    {
        ...
        {
        	parent.attribute.vZVector3Ds.clear();
            for(unsigned int i = 0; i < vec3fs.size(); ++i)
