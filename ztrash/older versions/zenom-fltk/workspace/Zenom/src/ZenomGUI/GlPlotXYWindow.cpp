...
// GlPlotXYWindow::save
//==============================================================================
void GlPlotXYWindow::save(pugi::xml_node pLineNodes)
{
    for (int i = 0 ; i < lineXYarray.getNumElements() ; ++i )
    {
        pugi::xml_node line = pLineNodes.append_child("Line");
        line.append_attribute("LogVariable") = lineXYarray.getElement(i)->getLogVariableGUI()->getName();
        line.append_attribute("R") = lineXYarray.getElement(i)->getR();
        line.append_attribute("G") = lineXYarray.getElement(i)->getG();
        line.append_attribute("B") = lineXYarray.getElement(i)->getB();
     }
