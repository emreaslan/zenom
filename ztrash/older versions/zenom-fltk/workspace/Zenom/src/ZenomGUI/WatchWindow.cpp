...
// WatchWindow::save
//==============================================================================
void WatchWindow::save(pugi::xml_node pWatchWindowNode)
{
    pWatchWindowNode.append_attribute("LogVariable") = logVariable->getName();
    pWatchWindowNode.append_attribute("X") = x();
    pWatchWindowNode.append_attribute("Y") = y();
    pWatchWindowNode.append_attribute("W") = w();
    pWatchWindowNode.append_attribute("H") = h();
    pWatchWindowNode.append_attribute("BackGroundColor") = editBGColorButton->color();
    pWatchWindowNode.append_attribute("SevenSegmentColor") = edit7SColorButton->color();
    pWatchWindowNode.append_attribute("Precision") = precision;
    /*
