...
#ifndef _ERRNOEXCEPTIONXP_HPP_INCLUDED
#define _ERRNOEXCEPTIONXP_HPP_INCLUDED
...
//------------------------------------------------------------------------------
// \brief
// ErrnoException sınıfı, hata oluşması durumunda throw edilecek exception
// tipidir. Bu obje ile hatalar daha iyi ifade edilir.
//
// <b>Ornek Program:</b>
// \include ErrnoExceptionXp.t.cpp
//==============================================================================
