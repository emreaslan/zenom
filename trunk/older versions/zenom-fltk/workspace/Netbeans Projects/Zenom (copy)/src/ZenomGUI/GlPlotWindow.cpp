...
// GlPlotWindow::save
//==============================================================================
Array< LogVarLine > GlPlotWindow::save()
{
    ...
    {
        line.logVariable = lineArray.getElement(i)->getLogVariableGUI();
        line.index = lineArray.getElement(i)->getLogIndex();
        line.r = lineArray.getElement(i)->getR();
        line.g = lineArray.getElement(i)->getG();
        line.b = lineArray.getElement(i)->getB();
