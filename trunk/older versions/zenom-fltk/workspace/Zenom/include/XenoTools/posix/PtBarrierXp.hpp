...
#ifndef _PTBARRIERXP_HPP_INCLUDED
#define _PTBARRIERXP_HPP_INCLUDED
...
// \brief
// 
// PtBarrier sınıfı, thread senkronizasyonu için kullanılır. Threadlerin bir
// noktaya kadar ilerleyip, bu noktada birbirleri ile senkron şekilde 
// çalışmalarını sağlar.
// 
// <b>Ornek Program:</b>
// \include PtBarrierXp.t.cpp
//==============================================================================
